...
exports.ConnectionError = function(parentError) {
	exports.BaseError.call(
		this,
		parentError ? parentError.message : 'Connection Error'
	);
	this.parent = this.original = parentError;
...
exports.InvalidQueryResultError = function(message) {
	exports.BaseError.call(
		this,
		message || 'Invalid query result was queued. Unable to complete mock query'
	);
...
exports.EmptyQueryQueueError = function(message) {
	exports.BaseError.call(
		this,
		message ||
			'No query results are queued. Unexpected query attempted to be run'
	);
